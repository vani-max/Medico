    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
       {
        ...
        <div className='mt-10'>
          {
            isEdit? 
            <button className='border border-[#3b82f6] px-8 py-2 rounded-full hover:bg-[#3b82f6] hover:text-white transition-all' onClick={updateUserProfile}>Save Information</button>
            : <button className='border border-[#3b82f6] px-8 py-2 rounded-full hover:bg-[#3b82f6] hover:text-white transition-all' onClick={()=>setIsEdit(true)}>Edit</button>
          }
        </div>
    </div>
  )
