...
const Doctors = () => {
  ...
  return (
    <div>
       <p className='text-gray-600'>Browse through doctor's speciality</p> 
       <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        <button onClick={()=>setShowFilter(prev => !prev)} className={`py-1 px-3 border rounded text-sm transition-all sm:hidden ${showFilter? 'bg-[#3b82f6] text-white' : ''}`}>Filters</button>
